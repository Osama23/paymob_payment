...
//
//     final kisokModel = kisokModelFromJson(jsonString);

import 'dart:convert';

KisokModel kisokModelFromJson(String str) => KisokModel.fromJson(json.decode(str));

String kisokModelToJson(KisokModel data) => json.encode(data.toJson());
